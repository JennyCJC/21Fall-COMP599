...
# classify_real_labelled_nodes(coraGraph, coraLabel, coraTestIndex)
# classify_real_labelled_nodes(citeseerGraph, citeseerLabel, citeseerTestIndex)
# classify_real_labelled_nodes(pubmedGraph, pubmedLabels, pubmedTestIndex)
